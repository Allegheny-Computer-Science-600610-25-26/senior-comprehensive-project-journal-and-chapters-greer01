...
![Driving distance distribution across a synthesized dataset of golfers. This histogram shows the wide performance measures of driving distance, which allows for CaddySense's need for AI coaching, rather than traditional non-personalized coaching.](images/HistogramCP.png){width=30%}

![Relationship between driving distance to greens in regulation percentage. This scattered pattern shows how longer drivers of the golf ball do not always score better on approach shots. This shows how the system needs multiple metrics instead of relying on a few.](images/ScatterplotCP.png){width=30%}
